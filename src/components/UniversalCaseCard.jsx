...
const UniversalCaseCard = ({gradientColor, price}) => {
  return (
    ...
    <Box component='img' src='/public/bag.svg' sx={{position: 'absolute', top: '12px', left: '50%', transform: 'translateX(-50%)'}} />
    <Box sx={{width: '100%', display: 'flex', justifyContent: 'space-between',}}>
     ...
     <Box sx={{display: 'flex', alignItems: 'center', gap: '5px'}}>
        ...
        <Box component='img' src='/public/almaz.svg' sx={{width: '16px', height: '16px'}} />
     </Box>
    </Box>
    </Box>
  )
